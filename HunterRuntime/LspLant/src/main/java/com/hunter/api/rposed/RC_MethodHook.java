...
import com.hunter.api.rposed.callbacks.IXUnhook;
import com.hunter.api.rposed.callbacks.XCallback;
...
public abstract class RC_MethodHook extends XCallback {
	/**
	 ...
	 */
	public class Unhook implements IXUnhook<RC_MethodHook> {
