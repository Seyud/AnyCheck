...
import com.hunter.external.gson.annotations.SerializedName;
 ...
 * - 字符串处理
 */
public class Encryptstack {
    /**
     * 是否保存栈信息
     */
    private static final boolean isSaveStack = true;
    /*
     * 是否hook解密算法
     */
    private static final boolean isHookEncry = true;

    /*
     * 是否JSON解密算法
     */
    private static final boolean isHookJson = true;
     ...
     * 可以随时取消Hook
     */
    private static final ArrayList<RC_MethodHook.Unhook> unHookList = new ArrayList<>();
...
//            new SimpleDateFormat("MM-dd  MM分:ss秒", Locale.getDefault());
    ...
    private static String Encryptstack_TAG = "zhenxiEncryptstack";
    ...
    public static synchronized void unHook() {
        for (RC_MethodHook.Unhook unhook : unHookList) {
            unhook.unhook();
        }
    }

    public static void StartEncryptstack(File fileName,Context context) throws IOException {
        mOtherContext = context;
        mLoader = context.getClassLoader();
        mSaveFile = fileName;
        if (!mSaveFile.exists()) {
            new File(mSaveFile.getParent()).mkdirs();
    ...
    public static void StartEncryptstack(String fileName,
                                         String TAG,Context context) throws IOException {
        Encryptstack_TAG = TAG;
        StartEncryptstack(new File(fileName),context);
    }
    ...
    public static void  Destroy(){
        ...
        FileUtils.saveStringNoCloseDestroy();
        //取消所有的hook
        unHook();
    }
    /**
     ...
     * @param msg
     */
    public static void InfiniteLog(String TAG, String msg) {
    ...
    private static String getStr(Object arg) {
        if (arg == null) {
            return "";
        }
    ...
    private static StringBuilder getMd5(byte[] result2) {
    ...
    private static void HookEncrypMethod() {
        try {
            if (isHookEncry) {
                ...
                try {
                    RC_MethodHook.Unhook encodeToString =
                            RposedHelpers.findAndHookMethod(Base64.class, Base64EncodeToString,
                                    byte[].class,
                                    int.class,
                                    new RC_MethodHook() {
                                        ...
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            ...
                                            FileUtils.saveStringNoClose(mOtherContext, mStringBuilder.toString(), mSaveFile);
                                        }
                                    }
                            );
                ...
                try {
                    RC_MethodHook.Unhook base64Encode =
                            RposedHelpers.findAndHookMethod(Base64.class, Base64Encode,
                                    byte[].class,
                                    int.class,
                                    new RC_MethodHook() {
                                        @Override
                ...
                try {
                    RC_MethodHook.Unhook resut =
                            RposedHelpers.findAndHookMethod(Base64.class, Base64Decode,
                                    byte[].class,
                                    int.class,
                                    new RC_MethodHook() {
...
//        byte[] decode = Base64.decode(String,int);
                ...
                try {
                    Set<RC_MethodHook.Unhook> resut =
                            RposedBridge.hookAllMethods(MessageDigest.class,
                                    Md5Digest,
                                    new RC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
...
//            msgDitest.update(Bytes[]);
                ...
                try {
                    Set<RC_MethodHook.Unhook> resut =
                            RposedBridge.hookAllMethods(MessageDigest.class, Update,
                                    new RC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            super.afterHookedMethod(param);
...
//            return Base64.encodeToString(instance.doFinal(bArr), 2);
                ...
                try {
                    Set<RC_MethodHook.Unhook> resut =
                            RposedBridge.hookAllMethods(Mac.class, "doFinal",
                                    new RC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            super.afterHookedMethod(param);
                ...
                try {
                    Set<RC_MethodHook.Unhook> resut =
                            RposedBridge.hookAllConstructors(IvParameterSpec.class,
                                    new RC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            super.afterHookedMethod(param);
...
//           Cipher ->getInstance
                try {
                    Set<RC_MethodHook.Unhook> resut =
                            RposedBridge.hookAllMethods(Cipher.class, "getInstance",
                                    new RC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            super.afterHookedMethod(param);
                ...
                try {
                    Set<RC_MethodHook.Unhook> resut =
                            RposedBridge.hookAllMethods(MessageDigest.class, "getInstance",
                                    new RC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            super.afterHookedMethod(param);
                ...
                try {
                    Set<RC_MethodHook.Unhook> resut =
                            RposedBridge.hookAllMethods(Mac.class, "getInstance",
                                    new RC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            super.afterHookedMethod(param);
                ...
                try {
                    Set<RC_MethodHook.Unhook> resut =
                            RposedBridge.hookAllMethods(Cipher.class, DoFinal,
                                    new RC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            super.afterHookedMethod(param);
            ...
            if (isHookJson) {
                ...
                try {
                    Set<RC_MethodHook.Unhook> resut =
                            RposedBridge.hookAllConstructors(JSONObject.class,
                                    new RC_MethodHook() {
                                        @Override
                                        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                            super.afterHookedMethod(param);
                ...
                Class<?> Gson = null;
                try {
                    Gson = RposedHelpers.findClass("com.google.gson.Gson", mLoader);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
                if (Gson != null) {
                    ...
                    try {
                        Set<RC_MethodHook.Unhook> resut = RposedBridge.hookAllMethods(Gson, "fromJson", new RC_MethodHook() {
                            @Override
                            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                super.afterHookedMethod(param);
                    ...
                    try {
                        Set<RC_MethodHook.Unhook> resut =
                                RposedBridge.hookAllConstructors(
                                        RposedHelpers.findClass("com.google.gson.JsonObject", mLoader),
                                        new RC_MethodHook() {
                                            @Override
                                            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                                super.afterHookedMethod(param);
                ...
                Class<?> JSON = null;
                try {
                    JSON = RposedHelpers.findClass("com.alibaba.fastjson.JSON", mLoader);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
                ...
                if (JSON != null) {
                    try {
                        Set<RC_MethodHook.Unhook> resut =
                                RposedBridge.hookAllConstructors(
                                        RposedHelpers.findClass("com.alibaba.fastjson.JSONObject", mLoader),
                                        new RC_MethodHook() {
                                            @Override
                                            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                                super.afterHookedMethod(param);
                    ...
                    try {
                        RC_MethodHook.Unhook resut =
                                ...
                                RposedHelpers.findAndHookMethod(JSON, "parse", String.class, new RC_MethodHook() {
                                            @Override
                                            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                                super.afterHookedMethod(param);
                    ...
                    try {
                        RC_MethodHook.Unhook resut =
                                ...
                                RposedHelpers.findAndHookMethod(JSON, "parseObject", String.class, new RC_MethodHook() {
                                            @Override
                                            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                                super.afterHookedMethod(param);
                    ...
                    try {
                        RC_MethodHook.Unhook resut =
                                ...
                                RposedHelpers.findAndHookMethod(JSON, "toJSONString", Object.class, new RC_MethodHook() {
                                            @Override
                                            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                                super.afterHookedMethod(param);
                ...
                Class<?> Jackson = null;
                try {
                    Jackson = RposedHelpers.findClass("com.fasterxml.jackson.databind.ObjectMapper", mLoader);
                } catch (Throwable e) {
                }
                if (Jackson != null) {
                    try {
                        RC_MethodHook.Unhook resut =
                                ...
                                RposedHelpers.findAndHookMethod(Jackson, "writeValueAsString", Object.class, new RC_MethodHook() {
                    ...
                    try {
                        RC_MethodHook.Unhook resut =
                                RposedHelpers.findAndHookMethod(Jackson,
                                        "readValue",
                                        String.class,
                                        Class.class,
                                        new RC_MethodHook() {
...
//                            RposedBridge.hookAllMethods(OutputStream.class,
//                                    "write",
//                                    new RC_MethodHook() {
//                                        @Override
//                                        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
//                                            super.beforeHookedMethod(param);
//                                            StringBuilder mStringBuilder = new StringBuilder(param.thisObject.getClass().getName()).append("->write()").append("\n");
//                                            parseParam(mStringBuilder, param);
//                                            if (isSaveStack) {
//                                                getStackTraceMessage(mStringBuilder);
//                                            }
...
//                    unHookList.addAll(resut);
//                } catch (Throwable e) {
//                    Log.e(Encryptstack_TAG, "hook OutputStream->write  error " + e.getMessage());
//                    e.printStackTrace();
//                }
//
//                //InputStream.class
...
//                    Set<RC_MethodHook.Unhook> resut =
//                            //GZIPOutputStream->write 将压缩字节流写进去时候进行拦截
//                            RposedBridge.hookAllMethods(InputStream.class,
//                                    "read",
//                                    new RC_MethodHook() {
//                                        @Override
//                                        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
//                                            super.beforeHookedMethod(param);
//                                            StringBuilder mStringBuilder = new StringBuilder(param.thisObject.getClass().getName()).append("->read()").append("\n");
//                                            parseParam(mStringBuilder, param);
//                                            if (isSaveStack) {
//                                                getStackTraceMessage(mStringBuilder);
//                                            }
...
//                    unHookList.addAll(resut);
//                } catch (Throwable e) {
//                    Log.e(Encryptstack_TAG, "hook InputStream->read  error " + e.getMessage());
//                    e.printStackTrace();
//                }
                ...
                try {
                    RC_MethodHook.Unhook resut =
                            //GZIPOutputStream->write 将压缩字节流写进去时候进行拦截
                            RposedHelpers.findAndHookMethod(ByteArrayOutputStream.class,
                                    "toString",
                                    String.class,
                                    new RC_MethodHook() {
    ...
    private static String getAlgorithm(Object arg) {
        try {
            ...
            try {
                ...
                Log.e(Encryptstack_TAG, "getEncodedMethodAndInvoke  异常   " + e.toString());
                e.printStackTrace();
            }
        } catch (Throwable e) {
            //Log.e(TAG,"NoSuchMethodException  异常   " + e.toString());
            e.printStackTrace();
        }
        return null;
    }
    ...
    private static byte[] getEncodedMethodAndInvoke(Object arg) {
        try {
            ...
            Log.e(Encryptstack_TAG, "NoSuchMethodException  异常   " + e.toString());
            e.printStackTrace();
        }
        return null;
    }
...
//            e.printStackTrace();
        ...
        try {
            if (keyField == null) {
                try {
                    ...
                    //Log.e(TAG,"getDeclaredField spi error  "+e.getMessage());
                }
            ...
            if (keyField != null) {
                ...
                if (spiObject != null) {
                    ...
                    if (cipherKeyResut.keyJson != null) {
                        SpiObject spiBean = GsonUtils.str2obj(cipherKeyResut.keyJson, SpiObject.class);
                        if (spiBean != null) {
            ...
            //Log.e(TAG,"打印结果toString "+cipherKeyResut.toString());
            return cipherKeyResut;
        } catch (Throwable e) {
            Log.e(Encryptstack_TAG, "getSpiKey error  " + e.getMessage());
        }
        return cipherKeyResut;
    }


    private static void parseParam(StringBuilder mStringBuilder, RC_MethodHook.MethodHookParam param) {
    ...
    public static void handler(Object obj,
                               StringBuilder mStringBuilder,
                               RC_MethodHook.MethodHookParam param) {
        if (obj instanceof Integer) {
            ...
            mStringBuilder.append("Cipher->").append(param.method.getName())
                    .append("  ").append(thisObject.getAlgorithm()).append("\n");
            //默认Iv == null
            byte[] iv;
            //尝试获取IV 可能会抛异常
            try {
