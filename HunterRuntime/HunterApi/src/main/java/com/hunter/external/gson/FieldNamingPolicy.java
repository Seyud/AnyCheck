...
public enum FieldNamingPolicy implements FieldNamingStrategy {
   ...
   * @since 1.4
   */
  UPPER_zhenxi_CASE_WITH_SPACES() {
    @Override public String translateName(Field f) {
      return upperCaseFirstLetter(separatezhenxiCase(f.getName(), " "));
    }
  },

  /**
   * Using this naming policy with Gson will modify the Java Field name from its com.zhenxi cased
  ...
  LOWER_CASE_WITH_UNDERSCORES() {
    @Override public String translateName(Field f) {
      return separatezhenxiCase(f.getName(), "_").toLowerCase(Locale.ENGLISH);
    }
  },
  ...
  LOWER_CASE_WITH_DASHES() {
    @Override public String translateName(Field f) {
      return separatezhenxiCase(f.getName(), "-").toLowerCase(Locale.ENGLISH);
    }
  },
  ...
  /**
   * Converts the field name that uses com.zhenxi-case define word separation into
   * separate words that are separated by the provided {@code separatorString}.
   */
  static String separatezhenxiCase(String name, String separator) {
