...
import com.hunter.external.gson.internal.$Gson$Preconditions;
import com.hunter.external.gson.internal.Excluder;
import com.hunter.external.gson.annotations.Expose;
import com.hunter.external.gson.internal.bind.TreeTypeAdapter;
...
import static com.hunter.external.gson.Gson.DEFAULT_COMPLEX_MAP_KEYS;
import static com.hunter.external.gson.Gson.DEFAULT_ESCAPE_HTML;
import static com.hunter.external.gson.Gson.DEFAULT_JSON_NON_EXECUTABLE;
import static com.hunter.external.gson.Gson.DEFAULT_LENIENT;
import static com.hunter.external.gson.Gson.DEFAULT_PRETTY_PRINT;
import static com.hunter.external.gson.Gson.DEFAULT_SERIALIZE_NULLS;
import static com.hunter.external.gson.Gson.DEFAULT_SPECIALIZE_FLOAT_VALUES;
 ...
 *     .setFieldNamingPolicy(FieldNamingPolicy.UPPER_zhenxi_CASE)
 *     .setPrettyPrinting()
 *     .setVersion(1.0)
 *     .create();
 * </pre></p>
