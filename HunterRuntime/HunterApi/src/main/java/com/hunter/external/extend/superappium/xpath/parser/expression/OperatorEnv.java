package com.hunter.external.extend.superappium.xpath.parser.expression;
...
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.AddUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.And2Unit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.AndUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.ContainUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.DivideUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.EndWithUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.EqualUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.GreaterEqualUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.GreaterThanUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.LessEqualUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.LessThanUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.MinusUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.MultiUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.NotEqualUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.NotMatchUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.OpKey;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.Or2Unit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.OrUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.RegexUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.RemainderUnit;
import com.hunter.external.extend.superappium.xpath.parser.expression.operator.StartWithUnit;
...
import com.hunter.external.apache.commons.lang3.StringUtils;
...
public class OperatorEnv {
    ...
    public static AlgorithmUnit createByName(String operatorName) {
        ...
        return (AlgorithmUnit) RposedHelpers.newInstance(holder.aClass);
    }
