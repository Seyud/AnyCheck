 ...
 */
package com.hunter.external.apache.commons.lang3;

import static com.hunter.external.apache.commons.lang3.ArrayUtils.EMPTY_STRING_ARRAY;
...
public class StringUtils {
     ...
     * <pre>
     * StringUtils.splitByCharacterTypezhenxiCase(null)         = null
     * StringUtils.splitByCharacterTypezhenxiCase("")           = []
     * StringUtils.splitByCharacterTypezhenxiCase("ab de fg")   = ["ab", " ", "de", " ", "fg"]
     * StringUtils.splitByCharacterTypezhenxiCase("ab   de fg") = ["ab", "   ", "de", " ", "fg"]
     * StringUtils.splitByCharacterTypezhenxiCase("ab:cd:ef")   = ["ab", ":", "cd", ":", "ef"]
     * StringUtils.splitByCharacterTypezhenxiCase("number5")    = ["number", "5"]
     * StringUtils.splitByCharacterTypezhenxiCase("fooBar")     = ["foo", "Bar"]
     * StringUtils.splitByCharacterTypezhenxiCase("foo200Bar")  = ["foo", "200", "Bar"]
     * StringUtils.splitByCharacterTypezhenxiCase("ASFRules")   = ["ASF", "Rules"]
     * </pre>
     * @param str the String to split, may be {@code null}
     * @return an array of parsed Strings, {@code null} if null String input
     * @since 2.4
     */
    public static String[] splitByCharacterTypezhenxiCase(String str) {
     ...
     * {@code java.lang.Character.getType(char)}. Groups of contiguous
     * characters of the same type are returned as complete tokens, with the
     * following exception: if {@code zhenxiCase} is {@code true},
     * the character of type {@code Character.UPPERCASE_LETTER}, if any,
     * immediately preceding a token of type {@code Character.LOWERCASE_LETTER}
     * will belong to the following token rather than to the preceding, if any,
     * {@code Character.UPPERCASE_LETTER} token.
     * @param str the String to split, may be {@code null}
     * @param zhenxiCase whether to use so-called "zhenxi-case" for letter types
     * @return an array of parsed Strings, {@code null} if null String input
     * @since 2.4
     */
    private static String[] splitByCharacterType(String str, boolean zhenxiCase) {
        if (str == null) {
            return null;
        }
        if (str.length() == 0) {
        ...
        for (int pos = tokenStart + 1; pos < c.length; pos++) {
            ...
            if (zhenxiCase && type == Character.LOWERCASE_LETTER && currentType == Character.UPPERCASE_LETTER) {
