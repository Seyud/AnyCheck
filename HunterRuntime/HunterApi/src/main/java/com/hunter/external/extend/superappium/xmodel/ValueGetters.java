package com.hunter.external.extend.superappium.xmodel;

import android.view.View;

import com.hunter.external.extend.superappium.ViewImage;
import com.hunter.external.extend.superappium.xmodel.basic.HintGetter;
import com.hunter.external.extend.superappium.xmodel.basic.ImageUriGetter;
import com.hunter.external.extend.superappium.xmodel.basic.TextGetter;
import com.hunter.external.extend.superappium.xmodel.view.BaseViewTypeGetter;
import com.hunter.external.extend.superappium.xmodel.view.ClassNameGetter;
import com.hunter.external.extend.superappium.xmodel.view.ClickableValueGetter;
import com.hunter.external.extend.superappium.xmodel.view.ContentDescValueGetter;
import com.hunter.external.extend.superappium.xmodel.view.EnabledValueGetter;
import com.hunter.external.extend.superappium.xmodel.view.FocusableValueGetter;
import com.hunter.external.extend.superappium.xmodel.view.HashCodeGetter;
import com.hunter.external.extend.superappium.xmodel.view.IdGetter;
import com.hunter.external.extend.superappium.xmodel.view.IndexGetter;
import com.hunter.external.extend.superappium.xmodel.view.LongClickableValueGetter;
import com.hunter.external.extend.superappium.xmodel.view.PackageNameValueGetter;
import com.hunter.external.extend.superappium.xmodel.view.SelectedValueGetter;
