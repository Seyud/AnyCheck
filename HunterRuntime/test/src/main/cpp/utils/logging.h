...
#define LOG_INFO zhenxi::LogMessage(__FILE__, __LINE__)
#define LOG_WARNING zhenxi::LogMessage(__FILE__, __LINE__)
#define LOG_ERROR zhenxi::LogMessage(__FILE__, __LINE__)
#define LOG_FATAL zhenxi::LogMessageFatal(__FILE__, __LINE__)
...
class LogMessage {
 ...
 public:
    ...
    void Flush() {
        ...
        //定义了 ZHENXI_BUILD_TYPE_NOLOG 则什么也不做
#else
