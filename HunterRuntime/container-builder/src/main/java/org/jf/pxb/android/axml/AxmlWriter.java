...
import static org.jf.pxb.android.ResConst.RES_STRING_POOL_TYPE;
import static org.jf.pxb.android.ResConst.RES_XML_CDATA_TYPE;
import static org.jf.pxb.android.ResConst.RES_XML_END_ELEMENT_TYPE;
import static org.jf.pxb.android.ResConst.RES_XML_END_NAMESPACE_TYPE;
import static org.jf.pxb.android.ResConst.RES_XML_RESOURCE_MAP_TYPE;
import static org.jf.pxb.android.ResConst.RES_XML_START_ELEMENT_TYPE;
import static org.jf.pxb.android.ResConst.RES_XML_START_NAMESPACE_TYPE;
import static org.jf.pxb.android.ResConst.RES_XML_TYPE;

import org.jf.pxb.android.StringItem;
import org.jf.pxb.android.StringItems;
                ...
                if (v instanceof StringItem) {
                  ...
                  out.putInt(Float.floatToIntBits((float) v));
                    ...
                    if(attr.value instanceof Integer) {
                        ...
                        out.put(((String) attr.value).getBytes(StandardCharsets.UTF_8));
                    }else {
                        System.exit(0);
                        System.out.println("not found type "+attr.value.getClass().getName());
                    }
